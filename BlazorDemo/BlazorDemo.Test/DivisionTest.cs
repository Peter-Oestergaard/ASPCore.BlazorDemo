...
public sealed class DivisionTest : TestContext
{
    ...
    public DivisionTest()
    {
        ...
        _addButton = calculatorComponent.Find("button:contains('Divide (/)')");
    ...
    [InlineData(4, 2)]
    [InlineData(4, 8)]
    public void DividingTwoIntegers_GivesCorrectResult(int a, int b)
    {
        // Act
        ...
        // Assert
        Assert.Equal(((double)a / b).ToString(CultureInfo.CurrentCulture), _result.GetAttribute("value"));
    }
