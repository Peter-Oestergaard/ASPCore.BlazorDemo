...
public sealed class MultiplicationTest : TestContext
{
    ...
    public MultiplicationTest()
    {
        ...
        _addButton = calculatorComponent.Find("button:contains('Multiply (X)')");
    ...
    [InlineData(1, 1)]
    [InlineData(1, -1)]
    public void MultiplyingTwoIntegers_GivesCorrectResult(int a, int b)
    {
        // Act
    ...
    [InlineData("-0", "-1")]
    [InlineData("-0", "-0")]
    public void MultiplyingSignedNumbersAndSignedZero_GivesCorrectResult(string a, string b)
    {
        ...
        double expectedDouble = ad * bd;
        string expected = Math.Abs(expectedDouble).ToString(CultureInfo.CurrentCulture);
    ...
    [InlineData(1, 0.1)]
    [InlineData(-1, -1.0)]
    public void MultiplyingIntegersAndDoubles_GivesCorrectResult(int a, double b)
    {
        // Arrange
    ...
    [InlineData(-1.0, -1.0)]
    [InlineData(2.0, 3.0)]
    public void MultiplyingDoublesAndDoubles_GivesCorrectResult(double a, double b)
    {
        // Arrange
        string expected = (a * b).ToString(CultureInfo.CurrentCulture);
    ...
    [Fact]
    public void MultiplyingDoubleMaxToDoubleMax_GivesPositiveInfinity()
    {
    ...
    [Fact]
    public void MultiplyingNegativeDoubleMaxToNegativeDoubleMax_GivesPositiveInfinity()
    {
    ...
    [Fact]
    public void MultiplyingDoubleMaxToNegativeDoubleMax_GivesNegativeInfinity()
    {
        double maxDouble = double.MaxValue;
        double negativeMaxDouble = double.MaxValue * -1;
